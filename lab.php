...
echo ' <form action="lab.php" method="get">
 ...
 if($_GET['lab']=='2'){
    echo "Проверить, что обвиняемые по одному делу не сидят в одной камере. <br>
Посчитать общую сумму гонорара (по делам, законченным в текущем году).<br>
Создать упорядоченные (по дате начала дела) списки:<br>
•	подзащитных (по делам);<br>
•	несовершеннолетних подзащитных;<br>
•	подзащитных, обвиняемых по статьям, максимальный срок по которым не меньше 10 лет.<br>";
  ...
  if($_GET['lab']=='3'){
      echo "1.	Представление Подзащитные, осужденные условно со сроком более одного года.<br>
...
<br>3.Представление Список статей: номер дела – номер статьи УК.<br>";
     if($_GET['p']=='1'){
